            ...
            <div class="form-group">
                    <label>
                        ...
                        <input type="text"
                            class="form-control"
                            #barcode="ngForm"
                            [formControl]="myForm.get('barcode')">
                    </label>
                    <!-- You can avoid exposing each control by using either form.get: -->
                    <div *ngIf="myForm.get('barcode').touched && myForm.get('barcode').hasError('required')"  class="alert alert-danger">Barcode is Required</div>
