...
@Component({
  ...
  template: `
      ...
      <article *ngIf="shouldShow" [@flyInOut]="'in'">
          ...
          <img src="http://thecatapi.com/api/images/get?format=src&type=gif">
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Vero debitis repellendus beatae error ducimus suscipit reiciendis omnis iusto
          magnam voluptatum soluta nam quos, ea nihil eaque assumenda iste dolorum eum!
      </article>
